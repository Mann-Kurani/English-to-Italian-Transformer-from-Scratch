# -*- coding: utf-8 -*-
"""translation en-it.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1V2dsijMpXWnocAUggU29zx4cnfJCCwlL
"""
...
def train_model(config):
  ...
  # Tensorboard (Allows to visulize loss charts)
  writer = SummaryWriter(config['experiment_name'])

  optimizer = torch.optim.Adam(model.parameters(), lr=config['lr'], eps=1e-9)
  initial_epoch = 0
  global_step = 0 # used mostly by tensor board to keep track of loss
  ...
  for epoch in range(initial_epoch, total_epochs):
    ...
    model.train()
    batch_iterator = tqdm(train_dataloader, desc=f'Processing epoch {epoch:02d} / {total_epochs:02d}')
...
def greedy_decode(model, source, source_mask, tokenizer_src, tokenizer_tgt, max_len, device):
  ...
  while True:
    ...
    # get the next token using the projection layer
